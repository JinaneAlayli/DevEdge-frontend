...
const Footer = () => {
  return (
    <footer className="bg-blue-600 text-white py-6">
      <div className="container mx-auto flex flex-col md:flex-row items-center  space-x-20 gap-20">
        ...
        <div className="flex flex-col md:flex-row justify-start items-start flex-1 space-x-20  md:space-y-0 gap-20">
